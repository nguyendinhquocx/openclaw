...
const enSystems = {
  systems: {
    ...
    desktopSetupReconnecting: "Waiting for the Gateway to restart and reconnect.",
    desktopSetupRestartHint: "This restarts the Gateway. This page reconnects automatically.",
